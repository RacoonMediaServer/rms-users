...
func (o *SignUpOKBody) validateToken(formats strfmt.Registry) error {

	if err := validate.Required("signUpOK"+"."+"token", "body", o.Token); err != nil {
		return err
	}
...
// ContextValidate validates this sign up o k body based on context it is used
